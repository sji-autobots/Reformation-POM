// Cart - add units
// https://thereformation.atlassian.net/browse/ENG-42065 
...
public class AddUnitsTest extends BaseTest {

    @org.testng.annotations.Test
    public void testAddUnits() throws InterruptedException {
        ...
        // Step 8: Click quantity dropdown and select higher quantity to ADD units
        ...
        // Step 9: Verify quantity was updated to 3
        try {
            WebElement qtyDropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("//select[@data-line-item-component='qty-action']")));
            ...
            if (qtyAfter.equals("3")) {
                System.out.println("PASS - Units successfully added. Quantity is now 3");
            } else {
